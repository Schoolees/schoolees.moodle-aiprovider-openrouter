...
final class provider_test extends \advanced_testcase {
    /**
     * Create a provider instance for unit testing.
     *
     * Moodle 5+ providers are configured per instance (config JSON is passed to the constructor).
     *
     * @return provider
     */
    private function create_provider(): provider {
        return new provider(
            enabled: true,
            name: 'OpenRouter',
            description: '',
